...
# #                   .progress = TRUE)
# # # # # # #
# # saveRDS(rs0, "/proj/DaltonLab/projects/lungTx/p0054/data/300TSAM_LAS_Runs_rec8.RDS")
# # saveRDS(rs0, "/proj/DaltonLab/projects/lungTx/p0054/data/300TSAM_LAS_Runs8.RDS")
# # # # # # # # # #
# # # # # # # ##
# sds <- 1001:2000
# rs0 <- future_map(sds, ~run_simulation(days = 802, can_start = 1275,
...
# # # # # #
# saveRDS(rs0, "/proj/DaltonLab/projects/lungTx/p0054/data/1000TSAM_LAS_Runs_rec8.RDS")
#
# rs0 <- future_map(sds, ~run_simulation(days = 802, can_start = 1275,
#                                         match_alg = match_cas, wl_model = "CAS23", post_tx_model = "CAS23", wl_weight = 0.25, post_tx_weight = 0.25,
#                                         wl_cap = 365, post_tx_cap = 1826, bio_weight = .15, pld_weight = 0.05, peds_weight = 0.2, efficiency_weight = 0.1,
#                                         seed = .x), .progress = TRUE)
# # # # #
# saveRDS(rs0, "/proj/DaltonLab/projects/lungTx/p0054/data/1000TSAM_LAS_Runs_rec8_cas.RDS")
# #
# rs0 <- future_map(sds, ~run_simulation(days = 802, can_start = 1275,
#                                         match_alg = match_cas, wl_model = "CAS23", post_tx_model = "CAS23", wl_weight = 0.25, post_tx_weight = 0.25,
#                                         wl_cap = 365, post_tx_cap = 1826, bio_weight = .15, pld_weight = 0.05, peds_weight = 0.2, efficiency_weight = 0,
#                                         seed = .x), .progress = TRUE)
# saveRDS(rs0, "/proj/DaltonLab/projects/lungTx/p0054/data/1000TSAM_LAS_Runs_rec8_cas0eff.RDS")
# ####
# rs0 <- future_map(sds, ~run_simulation(days = 802, can_start = 1275,
#                                         match_alg = match_cas, wl_model = "CAS23", post_tx_model = "CAS23", wl_weight = 0.25, post_tx_weight = 0.25,
#                                         wl_cap = 365, post_tx_cap = 1826, bio_weight = .15, pld_weight = 0.05, peds_weight = 0.2, efficiency_weight = 0.2,
#                                         seed = .x), .progress = TRUE)
# saveRDS(rs0, "/proj/DaltonLab/projects/lungTx/p0054/data/1000TSAM_LAS_Runs_rec8_cas2eff.RDS")
# #
# # ##
# #
...
# # # # # # #
# # saveRDS(rs0, "/proj/DaltonLab/projects/lungTx/p0054/data/300TSAM_LAS_Runs_rec8M.RDS")
# #
# # rs0 <- future_map(sds, ~run_simulation(days = 802, can_start = 1275,
# #                                        match_alg = match_cas, wl_model = "CAS23", post_tx_model = "CAS23", wl_weight = 0.25, post_tx_weight = 0.25,
# #                                        wl_cap = 365, post_tx_cap = 1826, bio_weight = .15, pld_weight = 0.05, peds_weight = 0.2, efficiency_weight = 0.1,
...
# # # # #
# # saveRDS(rs0, "/proj/DaltonLab/projects/lungTx/p0054/data/300TSAM_LAS_Runs_rec8_casM.RDS")
# # #
# # rs0 <- future_map(sds, ~run_simulation(days = 802, can_start = 1275,
# #                                        match_alg = match_cas, wl_model = "CAS23", post_tx_model = "CAS23", wl_weight = 0.25, post_tx_weight = 0.25,
# #                                        wl_cap = 365, post_tx_cap = 1826, bio_weight = .15, pld_weight = 0.05, peds_weight = 0.2, efficiency_weight = 0,
# #                                        seed = .x, include_matches = TRUE), .progress = TRUE)
# # saveRDS(rs0, "/proj/DaltonLab/projects/lungTx/p0054/data/300TSAM_LAS_Runs_rec8_cas0effM.RDS")
# # ###
# # rs0 <- future_map(sds, ~run_simulation(days = 802, can_start = 1275,
# #                                        match_alg = match_cas, wl_model = "CAS23", post_tx_model = "CAS23", wl_weight = 0.25, post_tx_weight = 0.25,
# #                                        wl_cap = 365, post_tx_cap = 1826, bio_weight = .15, pld_weight = 0.05, peds_weight = 0.2, efficiency_weight = 0.2,
# #                                        seed = .x, include_matches = TRUE), .progress = TRUE)
# # saveRDS(rs0, "/proj/DaltonLab/projects/lungTx/p0054/data/300TSAM_LAS_Runs_rec8_cas2effM.RDS")
# # # # #
# # # # #
# # # # # # ##### Evaluating
# # # # # # #
